...
**/!function( root, name, factory ) {
    ...
    //
    // parser factories
    var AceWorkerClient = function AceWorkerClient(topLevelNamespaces, mod, classname) {
    ...
    AceWorkerClient[PROTO] = Extend(ace_require("ace/worker/worker_client").WorkerClient[PROTO]);
    ...
    Parser[PROTO] = Merge(Extend(ace_require('ace/tokenizer').Tokenizer[PROTO]), {
        constructor: Parser,
